...
public class BinarySocketHandler extends BinaryWebSocketHandler {
    ...
    private static final Logger logger = LoggerFactory.getLogger(BinarySocketHandler.class);
    ...
    protected void handleBinaryMessage(WebSocketSession session, BinaryMessage message) throws Exception {
        ...
        session.sendMessage(new BinaryMessage(String.format("Hello %s" , s).getBytes()));
    }
